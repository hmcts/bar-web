...
module.exports = express.Router()
  ...
  // Search Payments Log
  .get(
    '/users/:id/payment-instructions/search',
    middleware.payments.validateIdForPayment,
    middleware.payments.validateStatusType,
    controllers.paymentsLogController.searchIndex
  )
